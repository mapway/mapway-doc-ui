...
public class MainFrame extends Composite {
  ...
  public void init(String target) {
    ...
    if (doc == null) {
      ApiDocProxy.fetchData(target, new IOnData<cn.mapway.document.ui.client.module.ApiDoc>() {
        @Override
        ...
        @Override
        public void onSuccess(String url, cn.mapway.document.ui.client.module.ApiDoc data) {
          parseData(data);
        }
      });
    } else {
